...
uint256 hashGenesisBlock("0x3d9e5080e63c65fb2dd117ea0330892e450c15b5a59c1a6c4e3fb2a01f16d0db");
...
const string strMessageMagic = "Crapcoin Signed Message:\n";
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    if(nHeight == 1) //premine funds for coin promotion & expenses
    {
        nSubsidy = 50000 * COIN;
    }
    else if(nHeight <= 1000) // double reward for first 1,000 blocks for early adopters
    {
        nSubsidy = 100 * COIN;
    }
    nSubsidy >>= (nHeight / 1600000);
    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 22.5 * 60; // Crapcoin: 2 days
static const int64 nTargetSpacing = 90; // Crapcoin: 90 second blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal crapcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Crapcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xc2002129516e05f672aa842d6136b48e503920727a68a80732ede554b1ea21da");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Happy F'N New Year, 2014!";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1388611207; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 5155092;
        ...
        assert(block.hashMerkleRoot == uint256("0x846cfa9e8b987a1a5c5648df50355be24f1dad86607aa964cd3afefded84f941"));
...
unsigned char pchMessageStart[4] = { 0xfc, 0xb7, 0xb7, 0xb7 };
